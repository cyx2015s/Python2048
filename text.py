...
def drawbox(text, rect, fontname=None, sysfontname=None, lineheight=None, anchor=None,
            bold=None, italic=None, underline=None, strip=None, maxsize=256, **kwargs):
    if fontname is None:
        fontname = DEFAULT_FONT_NAME
    if lineheight is None:
        lineheight = DEFAULT_LINE_HEIGHT
    ...
    fontsize = min(_fitsize(text, fontname, sysfontname, bold, italic, underline,
                            rect.width, rect.height, lineheight, strip), maxsize)
